...
const INFURA = false ? `https://mainnet.infura.io` : `https://rinkeby.infura.io`
const ETHERSCAN = false ? `https://etherscan.io` : `https://rinkeby.etherscan.io`
...
class Ethereum {
  ...
  fetchTokenBalance(address, tokenAddress, decimals) {
    ...
    return request.get(`${ETHERSCAN}/api?module=account&action=tokenbalance&contractaddress=${tokenAddress}&address=${address}`)
